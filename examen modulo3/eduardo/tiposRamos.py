...
class GenerarInicial:
    ...
    def produciendo_inicial(self):
        ...
        while i<1:
            ...
            indice= self.indiceramo
            indice.append(flor)
            i+=1
            return self.indiceramo
...
ramo1=GenerandoRamo()
iniciar=GenerarInicial()
ramogenerado=iniciar.produciendo_inicial()
print (ramogenerado)
ramo1.generar()
print (ramo1.generar)
#ini=GenerandoRamo(iniciar.produciendo_inicial())
